    ...
    <div className="flex flex-col w-11/12 h-screen mx-auto bg-black text-[#F6F6F6]">
      ...
      <div className="flex flex-col gap-6 text-3xl text-white">
        <div className="flex justify-between">
          ...
          <div className="px-[24px] py-[10px] w-[144px] rounded-lg border-[1px] bg-black border-[#4F4F4F] whitespace-nowrap text-sm text-white font-bold cursor-pointer text-center">
            Back to profile
          </div>
        </div>
